...
%prep
%setup -q -n yelp-xsl-3.34.2
cd %{_builddir}/yelp-xsl-3.34.2
...
cp %{_builddir}/yelp-xsl-3.34.2/COPYING.GPL %{buildroot}/usr/share/package-licenses/yelp-xsl/b47456e2c1f38c40346ff00db976a2badf36b5e3
cp %{_builddir}/yelp-xsl-3.34.2/COPYING.LGPL %{buildroot}/usr/share/package-licenses/yelp-xsl/545f380fb332eb41236596500913ff8d582e3ead
%make_install
