...
Source0  : https://download.gnome.org/sources/yelp-xsl/3.34/yelp-xsl-3.34.0.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568046093
...
cp COPYING.GPL %{buildroot}/usr/share/package-licenses/yelp-xsl/COPYING.GPL
cp COPYING.LGPL %{buildroot}/usr/share/package-licenses/yelp-xsl/COPYING.LGPL
%make_install
...
/usr/share/package-licenses/yelp-xsl/COPYING
/usr/share/package-licenses/yelp-xsl/COPYING.GPL
/usr/share/package-licenses/yelp-xsl/COPYING.LGPL
