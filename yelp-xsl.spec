...
Source0  : https://download.gnome.org/sources/yelp-xsl/3.38/yelp-xsl-3.38.0.tar.xz
...
%prep
%setup -q -n yelp-xsl-3.38.0
cd %{_builddir}/yelp-xsl-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600282765
...
cp %{_builddir}/yelp-xsl-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/yelp-xsl/3db6c7b240e7ee09baf9426dc9ed4aacb6904dbb
cp %{_builddir}/yelp-xsl-3.38.0/COPYING.GPL %{buildroot}/usr/share/package-licenses/yelp-xsl/b47456e2c1f38c40346ff00db976a2badf36b5e3
cp %{_builddir}/yelp-xsl-3.38.0/COPYING.LGPL %{buildroot}/usr/share/package-licenses/yelp-xsl/545f380fb332eb41236596500913ff8d582e3ead
%make_install
