...
Version  : 41.1
Release  : 23
URL      : https://download.gnome.org/sources/yelp-xsl/41/yelp-xsl-41.1.tar.xz
Source0  : https://download.gnome.org/sources/yelp-xsl/41/yelp-xsl-41.1.tar.xz
...
%prep
%setup -q -n yelp-xsl-41.1
cd %{_builddir}/yelp-xsl-41.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638607402
...
cp %{_builddir}/yelp-xsl-41.1/COPYING.GPL %{buildroot}/usr/share/package-licenses/yelp-xsl/b47456e2c1f38c40346ff00db976a2badf36b5e3
cp %{_builddir}/yelp-xsl-41.1/COPYING.LGPL %{buildroot}/usr/share/package-licenses/yelp-xsl/545f380fb332eb41236596500913ff8d582e3ead
%make_install
