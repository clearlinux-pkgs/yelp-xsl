...
Version  : 3.38.2
Release  : 18
URL      : https://download.gnome.org/sources/yelp-xsl/3.38/yelp-xsl-3.38.2.tar.xz
Source0  : https://download.gnome.org/sources/yelp-xsl/3.38/yelp-xsl-3.38.2.tar.xz
...
%prep
%setup -q -n yelp-xsl-3.38.2
cd %{_builddir}/yelp-xsl-3.38.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606161887
...
cp %{_builddir}/yelp-xsl-3.38.2/COPYING %{buildroot}/usr/share/package-licenses/yelp-xsl/3db6c7b240e7ee09baf9426dc9ed4aacb6904dbb
cp %{_builddir}/yelp-xsl-3.38.2/COPYING.GPL %{buildroot}/usr/share/package-licenses/yelp-xsl/b47456e2c1f38c40346ff00db976a2badf36b5e3
cp %{_builddir}/yelp-xsl-3.38.2/COPYING.LGPL %{buildroot}/usr/share/package-licenses/yelp-xsl/545f380fb332eb41236596500913ff8d582e3ead
%make_install
